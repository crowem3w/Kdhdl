...
class AgentLiveSession(
    ...
    companion object {
        ...
        suspend fun start(
            ...
            /** See [restoreOrFreshOrchestrator]'s `policyNBack` doc (gap-closure #1) for why this defaults to [reservoirWeights]' own `nBack` rather than [PolicyEngine.DEFAULT_N_BACK]. */
