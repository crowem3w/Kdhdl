...
class AgentSoakHarness(
    ...
    private val policyNInput: Int = reservoirWeights.nInput,
    private val policyNHidden: Int = reservoirWeights.nHidden,
    /** See [AgentLiveSession.start]'s `policyNBack` doc (gap-closure #1) for why this defaults to [reservoirWeights]' own `nBack` rather than [PolicyEngine.DEFAULT_N_BACK]. */
    private val policyNBack: Int = reservoirWeights.nBack,
